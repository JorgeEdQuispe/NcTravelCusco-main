        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 text-center">
                    ...
                    <p style="color: #fff" class="text-center">If you like exclusivity with luxury, these tourist destinations are made for you.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-5 pb-4">
                    <h2>Private and Exclusive Tours:</h2>
                </div>
                <!-----Fin orueba--->
