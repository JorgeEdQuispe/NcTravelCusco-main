            ...
            <div class="row align-items-center row-menu">
                ...
                <div class="col-10">
                    <nav class="site-navigation" role="navigation">
                        <div class="container">
                            <div class="d-inline-block d-lg-none ml-md-0 mr-auto py-3 icon-menu">
                            ...
                            <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li>
                                    {{-- <button type="button" onclick="window.location='{{ URL::route('inicio'); }}'" class="castellano-es">Español</button> --}}
                                </li>
                                <li>
                                    <div class="row">
                                        <div class="col">
