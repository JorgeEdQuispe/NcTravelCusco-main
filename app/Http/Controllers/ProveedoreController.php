...
class ProveedoreController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('proveedores.proveedore.index', compact('proveedores'))
    ...
    public function create()
    {
        ...
        $categorias = Categoriaproveedore::pluck('nombre', 'id');
        return view('proveedores.proveedore.create', compact('proveedore', 'categorias'));
    }
    ...
    public function show($id)
    {
        ...
        return view('proveedores.proveedore.show', compact('proveedore'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('proveedores.proveedore.edit', compact('proveedore', 'categorias'));
    }
